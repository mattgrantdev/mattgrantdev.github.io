...
<div class="spotify-widget-wrapper">
    <iframe class="spotify-widget" src="https://open.spotify.com/embed/playlist/0BOs8HoelLHuT3HwohSUBc" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
...
<div class="spotify-widget-wrapper">
    <iframe class="spotify-widget" src="https://open.spotify.com/embed/playlist/3iEAU893jAgpK8PUzmIDlq" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    <div class="spotify-widget-description description-right">
        <h3>Nostalgic</h3>
        <span>
...
<div class="spotify-widget-wrapper">
    <iframe class="spotify-widget" src="https://open.spotify.com/embed/playlist/3k6lVy1MpECNZsnTOZrh4h" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    <div class="spotify-widget-description description-right">
...
<hr />
<h1 class="text-center"> Bonus Spotify Playlists </h1>
...
<div class="spotify-widget-wrapper">
    <iframe class="spotify-widget" src="https://open.spotify.com/embed/playlist/2ygXgi7jBUZokCZSPXOdcr" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
    <div class="spotify-widget-description description-right">
